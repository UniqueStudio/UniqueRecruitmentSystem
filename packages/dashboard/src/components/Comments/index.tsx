...
const Comments: FC<Props> = memo(({ savedComment, comments, uid, changeInputting, submit, cid, enqueueSnackbar, username, remove }) => {
    ...
    return (
        <div className={classes.comments}>
            <div className={classes.evaluation}>
                ...
                />
                <Button color='primary' size='large' onClick={handleSubmit}>发表评论</Button>
            </div>
            <div>
                <Typography variant='caption' color='textSecondary'>可以发表多个评论，点击自己的评论进行修改</Typography>
            </div>
